...
?>
				...
				<thead>
					<tr><th style="background-color:white;">&nbsp;<center><a href="<?php echo url(''); ?>">หน้าแรก<?php echo$tablea."/".$tableb; ?></a></center>&nbsp;</th>@foreach($modela as $modella)

					<th id="{{$modella->id}}" style="background-color:#E6E6E6;">&nbsp;&nbsp;&nbsp;
					<a href="
<?php echo url('main/'.$linka.'/'.$modella->id); ?>
					">
					{{$modella->name}}
					</a>
					&nbsp;&nbsp;&nbsp;</th>
				...
				<tr>
					...
					&nbsp;&nbsp;<a href="
<?php echo url('main/'.$linkb); ?>/{{$modellb->id}}
					">
					{{$modellb->name}}
					</a>&nbsp;&nbsp;
					</th>
