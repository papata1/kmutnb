								...
								<div class="panel-body">
									<div class="table-responsive">
										...
										<table class="table table-bordered table-hover" id="sample-table-1">
											<tr><td width="200">รหัส</td><td>{{ $modell->pfix }}{{ $modell->id }}</td></tr>
											<tr><td width="200">ชื่อ</td><td>{{ $modell->name }}</td></tr>
											<tr><td width="200">ประเภท</td><td>{{ $modell->typee }}</td></tr>
											...
											<tr><td width="200">กระบวนการที่เกี่ยวข้อง</td>
												...
												@foreach($model4 as $modell4)
													<a href="<?php echo url('main/BusDetail/'. $modell4->blid ); ?>"> - {{$modell4->blname}}</a><br>
													@endforeach
												</td>
											</tr>
											<tr><td width="200">ระบบสารสนเทศที่เกี่ยวข้อง</td>
												<td>
													...
													<a href="<?php echo url('main/AppDetail/'. $modell3->alid ); ?>"> - {{$modell3->alname}}</a><br>
													@endforeach
												</td>
											</tr>
