								...
								<div class="panel-body">
									<div class="table-responsive">
										...
										<table class="table table-bordered table-hover" id="sample-table-1">
											<tr><td width="200">รหัส</td><td>{{ $modell->pfix }}{{ $modell->alid }}</td></tr>
											...
											<tr><td>กระบวนการที่เกี่ยวข้อง</td>
												<td>
													@foreach($model7 as $modell7)
													<a href="<?php echo url('main/BusDetail/'. $modell7->blid ); ?>">- {{$modell7->blname}}</a><br>
													@endforeach
												</td>
											</tr>
											<tr><td>ข้อมูลที่เกี่ยวข้อง</td>
												<td>
													@foreach($model8 as $modell8)
													<a href="<?php echo url('main/DatDetail/'. $modell8->dlid ); ?>">- {{$modell8->dlname}}</a><br>
													@endforeach
												</td>
											</tr>
