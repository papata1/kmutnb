								...
								<div class="col-md-12">
									...
									<div class="panel panel-default">
										<div style="height: 50px;padding:0" class="panel-heading">
											<div style="font-size:33px;">&nbsp;&nbsp;&nbsp;Application</div>
										</div>
...
<thead>
					<tr>
						...
						<th width="100"><center>ปีที่เริ่มใช้งาน</center></th>
				...
				<tbody>
					...
					<tr onclick="document.location = '<?php echo url('AppDetail/'.$model->alid); ?>';">
						<th>{{ $model->alid }}</th>
						<td>{{ $model->alname }}</td>
						<td>{{ $model->develop_language }}</td>
						<td>{{ $model->app_database }}</td>
						<td>{{ $model->getting_start_years }}</td>
						<td>{{ $model->app_relation }}</td>
